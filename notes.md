...
5. [Query performance tuning. Understanding the query planner by using `explain` and `analyze`](#5-query-performance-tuning-understanding-the-query-planner-by-using-explain-and-analyze)
